...
impl CliCommand for CliOtpXw {
    ...
    fn help(&self) -> CliHelpScreen {
        let mut help = CliHelpScreen::new(
            "Copy OTP Entry URL",
            "nyx otp xw <NAME>",
            "Copy OTP entry URL to clipboard",
        );

        help.add_param("NAME", "Name of entry to copy from.");
        help.add_example("nyx otp xw mysite/cloudflare");
        help
    }
}
