...
impl CliCommand for CliUserCopy {
    ...
    fn help(&self) -> CliHelpScreen {
        ...
        help.add_example("nyx cp mysite/pass1 anothersite/pass2");
        help
    }
}
