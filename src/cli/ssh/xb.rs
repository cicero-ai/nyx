...
impl CliCommand for CliSshKeyXb {
    fn process(&self, req: &CliRequest) -> anyhow::Result<()> {
        ...
        // Copy to clipboard
        clipboard::copy(&ssh_key.public_key)?;
    ...
    fn help(&self) -> CliHelpScreen {
        ...
        help.add_example("nyx ssh xb mysite/cloudflare");
        help
    }
}
